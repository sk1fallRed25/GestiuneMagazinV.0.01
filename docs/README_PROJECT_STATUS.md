...
- **Etapa 5E.4.2 (Următorul Pas)**: Implementare Store Context Switcher — adăugarea unui selector de magazin în bara de navigare pentru utilizatorii alocați pe multiple unități (rezolvare gap UX identificat în 5E.4.1).
