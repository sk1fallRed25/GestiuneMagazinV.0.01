...
- **Etapa 6B.2 (Următorul Pas)**: Sales Void MVP Implementation — implementarea fluxului de anulare totală (`void_sale`) pentru vânzările eligibile din tura curentă a casierului (aplicare manuală SQL, integrare service/hook/UI și validare E2E). Returul parțial avansat va fi abordat separat în Etapa 6B.3.
