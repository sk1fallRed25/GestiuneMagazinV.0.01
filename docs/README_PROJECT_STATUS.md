...
- **Etapa 6B.2.2 (Următorul Pas)**: Frontend & Service Integration — Extinderea `salesHistoryService.ts` cu metodele API pentru cele 2 RPC-uri și integrarea UI a butonului de „Anulare Bon” cu validarea eligibilității în modalul de detalii bon din Istoric Vânzări.
