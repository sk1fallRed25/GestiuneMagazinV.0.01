...
DROP TABLE IF EXISTS public.istoric_inventar CASCADE;
...
DROP TABLE IF EXISTS public.receptie_items CASCADE;
...
DROP TABLE IF EXISTS public.suport_tichete CASCADE;
