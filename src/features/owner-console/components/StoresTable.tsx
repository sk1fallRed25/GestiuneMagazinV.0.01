                    ...
                    <td className="py-4 px-5 text-center">
                      {(() => {
                        ...
                        switch (status) {
                          ...
                          case 'suspended':
                            return (
                              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-amber-500/10 text-amber-700 dark:text-amber-300 border border-amber-500/20 rounded-full text-xs font-semibold">
                          ...
                          case 'archived':
                            return (
                              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-purple-500/10 text-purple-700 dark:text-purple-300 border border-purple-500/20 rounded-full text-xs font-semibold">
                          ...
                          case 'pending_deletion':
                            return (
                              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-rose-500/10 text-rose-700 dark:text-rose-300 border border-rose-500/20 rounded-full text-xs font-semibold animate-pulse">
