            ...
            <div className="bg-white rounded-[2rem] p-8 w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 border border-slate-100 max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-8 pb-4 border-b border-slate-100">
                    <div>
                        ...
                        <p className="text-slate-400 text-[10px] mt-1 font-mono">UUID: {formData.id}</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                type="number" step="0.01"
                                className="w-full border border-slate-200 p-4 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-mono font-bold"
                                value={formData.pret_achizitie || 0}
                                onChange={e => setFormData({ ...formData, pret_achizitie: parseFloat(e.target.value) })}
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value={formData.um}
                            onChange={e => setFormData({ ...formData, um: e.target.value, unitate_masura: e.target.value })}
                            required
                        />
                    </div>
                    ...
                    <div className="bg-slate-50 p-6 rounded-3xl grid grid-cols-2 gap-6 border border-slate-100">
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => setFormData({ ...formData, stoc_depozit: parseFloat(e.target.value) })}
                                required
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => setFormData({ ...formData, stoc_magazin: parseFloat(e.target.value) })}
                                required
                            />
                        </div>
                    </div>
