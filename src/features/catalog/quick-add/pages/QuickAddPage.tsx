    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 font-sans">
            <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-2xl border border-gray-100">
                ...
                {/* STATUS BAR */}
                {status.msg && (
                    <div className={`p-4 rounded-xl mb-8 flex items-center gap-3 font-bold text-lg transition-all animate-in fade-in zoom-in duration-300 ${status.type === 'success' ? 'bg-green-50 text-green-700 border border-green-100' :
